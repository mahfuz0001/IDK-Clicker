  ...
  M.init = function (div) {
    ...
    M.spells = {
      "conjure baked goods": {
        ...
        desc: "Summon half an hour worth of your CpS, capped at 15% of your idk owned.",
        ...
        win: function () {
          var val = Math.max(
            7,
            Math.min(Game.idk * 0.15, Game.cookiesPs * 60 * 30)
          );
          Game.Earn(val);
          Game.Notify(
            "Conjure baked goods!",
        ...
        fail: function () {
          ...
          var val = Math.min(Game.idk * 0.15, Game.cookiesPs * 60 * 15) + 13;
          val = Math.min(Game.idk, val);
          Game.Spend(val);
      ...
      "hand of fate": {
        ...
        win: function () {
          ...
          var choices = [];
          choices.push("frenzy", "multiply idk");
          if (!Game.hasBuff("Dragonflight")) choices.push("click frenzy");
          if (Math.random() < 0.1)
            choices.push("chain cookie", "cookie storm", "blab");
          if (Game.BuildingsOwned >= 10 && Math.random() < 0.25)
            choices.push("building special");
          //if (Math.random()<0.2) choices.push('clot','cursed finger','ruin idk');
      ...
      "spontaneous edifice": {
        ...
        desc: "The spell picks a random building you could afford if you had twice your current idk, and gives it to you for free. The building selected must be under 400, and cannot be your most-built one (unless it is your only one).",
        ...
        win: function () {
          ...
          for (var i in Game.Objects) {
            if (
              ...
              Game.Objects[i].getPrice() <= Game.idk * 2 &&
        ...
        var str =
          ...
          (me.fail
            ? '<div><small>Chance to backfire : <b style="color:#f66">' +
              ...
              "%</b></small></div>"
            : "") +
          '<div class="line"></div><div class="description"><b>Effect :</b> ' +
          me.desc +
          (me.failDesc
            ? '<div style="height:8px;"></div><b>Backfire :</b> ' + me.failDesc
            : "") +
          "</div></div>";
        return str;
      };
    ...
    str +=
      ...
      Game.getTooltip(
        '<div style="padding:8px;width:300px;font-size:11px;text-align:center;">Click to refill <b>100 units</b> of your magic meter<br>for <span class="price lump">1 sugar lump</span>.</div>'
      ) +
      ' id="grimoireLumpRefill" class="usesIcon shadowFilter" style="background-position:' +
      -icon[0] * 48 +
      "px " +
      -icon[1] * 48 +
