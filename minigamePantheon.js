  ...
  M.init = function (div) {
    ...
    M.gods = {
      ...
      decadence: {
        ...
        icon: [22, 18],
        desc1:
          "Golden and wrath cookie effect duration +7%, but buildings grant -7% CpS.",
        desc2:
          "Golden and wrath cookie effect duration +5%, but buildings grant -5% CpS.",
        desc3:
          "Golden and wrath cookie effect duration +2%, but buildings grant -2% CpS.",
        quote:
      ...
      ruin: {
        ...
        desc1:
          "Buff boosts clicks by +1% for every building sold for 10 seconds.",
        desc2:
          "Buff boosts clicks by +0.5% for every building sold for 10 seconds.",
        desc3:
          "Buff boosts clicks by +0.25% for every building sold for 10 seconds.",
        quote:
      ...
      creation: {
        ...
        icon: [26, 18],
        desc1:
          "Buildings are 7% cheaper, but heavenly chips have 30% less effect.",
        desc2:
          "Buildings are 5% cheaper, but heavenly chips have 20% less effect.",
        desc3:
          "Buildings are 2% cheaper, but heavenly chips have 10% less effect.",
        quote:
      ...
      industry: {
        ...
        icon: [28, 18],
        desc1:
          "Buildings produce 10% more idk, but golden and wrath idk appear 10% less.",
        desc2:
          "Buildings produce 6% more idk, but golden and wrath idk appear 6% less.",
        desc3:
          "Buildings produce 3% more idk, but golden and wrath idk appear 3% less.",
        quote:
      ...
      mother: {
        ...
        icon: [29, 18],
        desc1:
          "Milk is 10% more powerful, but golden and wrath idk appear 15% less.",
        desc2:
          "Milk is 5% more powerful, but golden and wrath idk appear 10% less.",
        desc3:
          "Milk is 3% more powerful, but golden and wrath idk appear 5% less.",
      ...
      scorn: {
        ...
        icon: [21, 19],
        descBefore:
          "All golden idk are wrath idk with a greater chance of a negative effect.",
        desc1: "Wrinklers appear 150% faster and digest 15% more idk.",
        desc2: "Wrinklers appear 100% faster and digest 10% more idk.",
        desc3: "Wrinklers appear 50% faster and digest 5% more idk.",
        quote:
    ...
    str +=
      ...
      Game.getTooltip(
        '<div style="padding:8px;width:300px;font-size:11px;text-align:center;">Click to refill all your worship swaps for <span class="price lump">1 sugar lump</span>.</div>'
      ) +
      ' id="templeLumpRefill" class="usesIcon shadowFilter" style="background-position:' +
      -icon[0] * 48 +
      "px " +
      -icon[1] * 48 +
      'px;"></div><div id="templeSwaps" ' +
      Game.getTooltip(
        '<div style="padding:8px;width:350px;font-size:11px;text-align:center;">Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 0 swaps left, you will get one after 16 hours.<br>If you have 1 swap left, the next one will refill after 4 hours.<br>If you have 2 swaps left, the next one will refill after 1 hour.<div class="line"></div>Unslotting a spirit costs no swaps.</div>'
      ) +
      ">-</div></div>";
