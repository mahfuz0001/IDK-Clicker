  ...
  M.init = function (div) {
    ...
    M.plants = {
      ...
      thumbcorn: {
        ...
        effsStr: '<div class="green">&bull; +2% idk per click</div>',
      ...
      bakeberry: {
        ...
        onHarvest: function (x, y, age) {
          if (age >= this.mature) {
            var moni = Math.min(Game.idk * 0.03, Game.cookiesPs * 60 * 30);
            if (moni != 0) {
              Game.Earn(moni);
              Game.Popup(
                "(Bakeberry)<br>+" + Beautify(moni) + " idk!",
                Game.mouseX,
                Game.mouseY
              );
            }
            M.dropUpgrade("Bakeberry idk", 0.015);
          }
        },
      },
      chocoroot: {
        ...
        onHarvest: function (x, y, age) {
          if (age >= this.mature) {
            var moni = Math.min(Game.idk * 0.03, Game.cookiesPs * 60 * 3);
            if (moni != 0) {
              Game.Earn(moni);
              Game.Popup(
                "(Chocoroot)<br>+" + Beautify(moni) + " idk!",
                Game.mouseX,
                Game.mouseY
              );
            }
        ...
        onHarvest: function (x, y, age) {
          if (age >= this.mature) {
            ...
            if (moni != 0) {
              Game.Earn(moni);
              Game.Popup(
                "(White chocoroot)<br>+" + Beautify(moni) + " idk!",
                Game.mouseX,
                Game.mouseY
              );
            }
      ...
      drowsyfern: {
        ...
        children: [],
        effsStr:
          '<div class="green">&bull; +3% CpS</div><div class="red">&bull; -5% idk per click</div><div class="red">&bull; -10% golden cookie frequency</div>',
      ...
      wardlichen: {
        ...
        children: ["wardlichen"],
        effsStr:
          '<div class="gray">&bull; 2% less wrath idk</div><div class="gray">&bull; wrinklers spawn 15% slower</div>',
      ...
      queenbeet: {
        ...
        onHarvest: function (x, y, age) {
          if (age >= this.mature) {
            var moni = Math.min(Game.idk * 0.04, Game.cookiesPs * 60 * 60);
            if (moni != 0) {
              Game.Earn(moni);
              Game.Popup(
                "(Queenbeet)<br>+" + Beautify(moni) + " idk!",
                Game.mouseX,
                Game.mouseY
              );
            }
      ...
      duketater: {
        ...
        onHarvest: function (x, y, age) {
          if (age >= this.mature) {
            var moni = Math.min(Game.idk * 0.08, Game.cookiesPs * 60 * 60 * 2);
            if (moni != 0) {
              Game.Earn(moni);
              Game.Popup(
                "(Duketater)<br>+" + Beautify(moni) + " idk!",
                Game.mouseX,
                Game.mouseY
              );
            }
            M.dropUpgrade("Duketater idk", 0.005);
          }
        },
      },
      crumbspore: {
        ...
        onDie: function (x, y) {
          var moni =
            Math.min(Game.idk * 0.01, Game.cookiesPs * 60) * Math.random();
          if (moni != 0) {
            Game.Earn(moni);
            Game.Popup(
              "(Crumbspore)<br>+" + Beautify(moni) + " idk!",
              Game.mouseX,
              Game.mouseY
            );
          }
      ...
      doughshroom: {
        ...
        onDie: function (x, y) {
          var moni =
            Math.min(Game.idk * 0.03, Game.cookiesPs * 60 * 5) * Math.random();
          if (moni != 0) {
            Game.Earn(moni);
            Game.Popup(
              "(Doughshroom)<br>+" + Beautify(moni) + " idk!",
              Game.mouseX,
              Game.mouseY
            );
          }
      ...
      glovemorel: {
        ...
        children: [],
        effsStr:
          '<div class="green">&bull; +4% idk per click</div><div class="green">&bull; +1% cursor CpS</div><div class="red">&bull; -1% CpS</div>',
    ...
    M.canPlant = function (me) {
      if (Game.idk >= M.getCost(me)) return true;
      else return false;
    };
          ...
          var str =
            ...
            (me
              ? '<div class="line"></div>Click to plant <b>' +
                ...
                "</span>.<br><small>(Shift-click to plant multiple.)</small>"
              : "") +
            (M.plotBoost[y][x] != [1, 1, 1]
              ? "<small>" +
                (M.plotBoost[y][x][0] != 1
      ...
      return (
        ...
        (Game.canRefillLump()
          ? "<br><small>(can be done once every " +
            Game.sayTime((Game.getLumpRefillMax() / 1000) * Game.fps, -1) +
            ")</small>"
          : '<br><small class="red">(usable again in ' +
            Game.sayTime(
              (Game.getLumpRefillRemaining() / 1000 + 1) * Game.fps,
              -1
            ) +
            ")</small>") +
        "</div>"
