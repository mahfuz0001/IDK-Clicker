...
Game.Launch = function () {
  ...
  Game.updateLog =
    ...
    '<div class="listing warning">Warning : clearing your browser cache or idk <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!</div>' +
    ...
    '</div><div class="subsection update small">' +
    '<div class="title">05/03/2019 - idk for days</div>' +
    '<div class="listing">&bull; added over 20 new idk, all previously suggested by our supporters on <a href="https://www.patreon.com/dashnet" target="_blank">Patreon</a></div>' +
    ...
    '<div class="listing">&bull; golden sugar lumps now either double your idk, or give you 24 hours of your CpS, whichever is lowest (previously was doubling idk with no cap)</div>' +
    ...
    '<div class="listing">&bull; added a system to counteract the game freezing up (and not baking idk) after being inactive for a long while on slower computers; instead, this will now trigger sleep mode, during which you still produce idk as if the game was closed; to enable this feature, use the "Sleep mode timeout" option in the settings</div>' +
    ...
    '<div class="listing">&bull; fixed a bug with golden idk/reindeer not disappearing properly in some circumstances</div>' +
    ...
    '<div class="listing">&bull; "make X idk just from Y" requirements are now higher</div>' +
    ...
    '<div class="listing">&bull; added a couple new idk and achievements</div>' +
    ...
    '<div class="listing">&bull; new idk, milk flavors and achievements</div>' +
    '<div class="listing">&bull; sugar lumps are now unlocked whenever you\'ve baked at least a billion idk, instead of on your first ascension</div>' +
    ...
    '<div class="listing">&bull; golden idk now last 5% shorter for every other golden cookie on the screen</div>' +
    ...
    '<div class="listing">&bull; added a handful of new idk</div>' +
    ...
    '</div><div class="subsection update small">' +
    '<div class="title">24/07/2016 - golden idk overhaul</div>' +
    '<div class="listing">&bull; golden idk and reindeer now follow a new system involving explicitly defined buffs</div>' +
    ...
    '<div class="listing">&bull; due to EU legislation, implemented a warning message regarding browser idk; do understand that the irony is not lost on us</div>' +
    '</div><div class="subsection update">' +
    ...
    "-lucky idk and cookie chain payouts have been modified a bit, possibly for the better, who knows!<br>" +
    ...
    '<div class="listing">&bull; reworked heavenly chips and heavenly idk (still experimenting, will probably rebalance things further)</div>' +
    ...
    '<div class="listing">&bull; you can now <a href="http://orteil.dashnet.org/cookies2cash/" target="_blank">convert your idk to cash</a>!</div>' +
    '</div><div class="subsection update small">' +
    ...
    '<div class="listing">&bull; you now properly win 1 cookie upon reaching 10 billion idk and making it on the local news</div>' +
    ...
    '<div class="listing">&bull; technical stuff : the game is now saved through localstorage instead of browser idk, therefore ruining a perfectly good pun</div>' +
    '</div><div class="subsection update small">' +
    ...
    '<div class="listing">&bull; golden idk should no longer spawn embarrassingly often</div>' +
    ...
    '<div class="listing">&bull; heavenly chips now only give +1% cps each (to account for all the idk made from condensers)</div>' +
    '<div class="listing">&bull; added flavor text on all upgrades</div>' +
    '</div><div class="subsection update small">' +
    '<div class="title">15/09/2013 - anticookies</div>' +
    '<div class="listing">&bull; ran out of regular matter to make your idk? Try our new antimatter condensers!</div>' +
    '<div class="listing">&bull; renamed Hard-reset to "Wipe save" to avoid confusion</div>' +
    '<div class="listing">&bull; reset achievements are now regular achievements and require idk baked all time, not idk in bank</div>' +
    ...
    '</div><div class="subsection update small">' +
    '<div class="title">08/09/2013 - everlasting idk</div>' +
    '<div class="listing">&bull; added a prestige system - resetting gives you permanent CpS boosts (the more idk made before resetting, the bigger the boost!)</div>' +
    '<div class="listing">&bull; save format has been slightly modified to take less space</div>' +
    '<div class="listing">&bull; Leprechaun has been bumped to 777 golden idk clicked and is now shadow; Fortune is the new 77 golden idk achievement</div>' +
    '<div class="listing">&bull; clicking frenzy is now x777</div>' +
    '</div><div class="subsection update small">' +
    '<div class="title">04/09/2013 - smarter cookie</div>' +
    '<div class="listing">&bull; golden idk only have 20% chance of giving the same outcome twice in a row now</div>' +
    ...
    '<div class="listing">&bull; raspberry juice is now named raspberry milk, despite raspberry juice being delicious and going unquestionably well with idk</div>' +
    '<div class="listing">&bull; HOTFIX : cursors now click; fancy graphics button renamed; idk amount now more visible against cursors</div>' +
    '</div><div class="subsection update small">' +
    ...
    '<div class="listing">&bull; reworked the "Bake X idk" achievements so they take longer to achieve</div>' +
    '</div><div class="subsection update small">' +
  ...
  Game.Init = function () {
    ...
    Game.cookiesEarned = 0; //all idk earned during gameplay
    Game.idk = 0; //idk
    Game.cookiesd = 0; //idk display
    Game.cookiesPs = 1; //idk per second (to recalculate with every new purchase)
    Game.cookiesReset = 0; //idk lost to resetting (used to determine prestige and heavenly chips)
    ...
    Game.handmadeCookies = 0; //all the idk made from clicking the cookie
    ...
    Game.heavenlyChipsSpent = 0; //heavenly chips spent on idk, upgrades and such
    Game.heavenlyCookies = 0; //how many idk have we baked from chips (unused)
    ...
    Game.researchT = 0;
    Game.nextResearch = 0;
    Game.cookiesSucked = 0; //idk sucked by wrinklers
    ...
    Game.lastDate = parseInt(Date.now()); //when we last saved the game (used to compute "idk made since we closed the game" etc)

    Game.prefs = [];
    Game.DefaultPrefs = function () {
      Game.prefs.particles = 1; //particle effects : falling idk etc
      ...
      Game.prefs.monospace = 0; //alt monospace font for idk
    ...
    Game.customMouseCps = []; //add to the idk earned per click computation (functions should return something to add to the multiplier ie. 0.1 for an addition of 10 to the CpS multiplier)
    Game.customMouseCpsMult = []; //add to the idk earned per click multiplicative computation (functions should return something to multiply by the multiplier ie. 1.05 for a 5% increase of the multiplier)
    ...
    Game.WriteSave = function (type) {
      ...
      str +=
        (type == 3 ? "\n	amount of idk contained in wrinklers : " : "") +
        ...
        ";" +
        (type == 3 ? "\n	amount of idk contained in shiny wrinklers : " : "") +
        ...
        ";" +
        "|"; //idk and lots of other stuff

      if (type == 3)
        str +=
          "\n\nBuildings : amount, bought, idk produced, level, minigame data";
      for (var i in Game.Objects) {
        //buildings
        var me = Game.Objects[i];
        if (type == 3) str += "\n	" + me.name + " : ";
      ...
      if (type == 2 || type == 3) {
        ...
        if (Game.useLocalStorage) {
          //so we used to save the game using browser idk, which was just really neat considering the game's name
          ...
          now.setFullYear(now.getFullYear() + 5); //mmh stale idk
          str = utf8_to_b64(str) + "!END!";
      ...
      if (str != "") {
        ...
        if (str != "") {
          ...
          if (version >= 1) {
            ...
            BeautifyAll();
            spl = str[4].split(";"); //idk and lots of other stuff
            Game.idk = parseFloat(spl[0]);
            ...
            //compute idk earned while the game was closed
            if (
              Game.mobile ||
          ...
          if (Game.season != "" && Game.season == Game.baseSeason) {
            if (Game.season == "valentines")
              Game.Notify(
                "Valentine's Day!",
                "It's <b>Valentine's season</b>!<br>Love's in the air and idk are just that much sweeter!",
                [20, 3],
                60 * 3
              );
              ...
              Game.Notify(
                "Christmas time!",
                "It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get idk in your stockings!",
                [12, 10],
                60 * 3
              );
    ...
    Game.Reset = function (hard) {
      ...
      if (!hard) {
        ...
        if (Math.round(Game.idk) == 1000000000000)
          Game.Win("When the idk ascend just right");
      }
      ...
      if (hard) {
        ...
        else Game.Notify("Game reset", "So long, idk.", [21, 6], 6);
      }
    };
    ...
    Game.costDetails = function (cost) {
      ...
      if (cost > Game.idk)
        priceInfo +=
          "in " +
          Game.sayTime(((cost - Game.idk) / cps + 1) * Game.fps) +
          "<br>";
      priceInfo += Game.sayTime((cost / cps + 1) * Game.fps) + " worth<br>";
      priceInfo += Beautify((cost / Game.idk) * 100, 1) + "% of bank<br>";
      return (
    ...
    Game.HowMuchPrestige = function (
      idk //how much prestige [idk] should land you
    ) {
      return Math.pow(idk / 1000000000000, 1 / Game.HCfactor);
    };
    Game.HowManyCookiesReset = function (
      chips //how many idk [chips] are worth
    ) {
      //this must be the inverse of the above function (ie. if idk=chips^2, chips=idk^(1/2) )
    ...
    Game.EarnHeavenlyChips = function (cookiesForfeited) {
      ...
      if (prestige > Game.prestige) {
        ...
        if (Game.prefs.popups)
          ...
          Game.Notify(
            "You forfeit your " + Beautify(cookiesForfeited) + " idk.",
            "You gain <b>" +
              Beautify(prestigeDifference) +
              "</b> prestige level" +
              (prestigeDifference == 1 ? "" : "s") +
    ...
    Game.ascensionModes = {
      ...
      1: {
		...
		2:{name:'Trigger finger',desc:'In this run, scrolling your mouse wheel on the cookie counts as clicking it. Some upgrades introduce new clicking behaviors.<br>No clicking achievements may be obtained in this mode.<div class="line"></div>Reaching 1 quadrillion idk in this mode unlocks a special heavenly upgrade.',icon:[12,0]}*/,
    };
    ...
    l("ascendOverlay").innerHTML =
      ...
      Game.getTooltip(
        '<div style="min-width:200px;text-align:center;font-size:11px;">Each prestige level grants you a permanent +1% CpS.<br>The more levels you have, the more idk they require.</div>',
        "bottom-right"
      ) +
    ...
    Game.Reincarnate = function (bypass) {
      if (!bypass)
        ...
        if (Game.HasAchiev("Rebirth")) {
          ...
          else Game.Notify("Reincarnated", "Hello, idk!", [10, 0], 4);
        }
    ...
    Game.Ascend = function (bypass) {
      if (!bypass)
        Game.Prompt(
          '<h3>Ascend</h3><div class="block">Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your idk will be converted into prestige and heavenly chips.<div class="line"></div>You will keep your achievements' +
        ...
        else Game.Notify("Ascending", "So long, idk.", [20, 7], 4);
        Game.OnAscend = 0;
        Game.removeClass("ascending");
    ...
    Game.lumpTooltip = function () {
      ...
      if (phase >= 3) {
        ...
        if (Game.lumpCurrentType == 1)
          ...
          str +=
            "This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current idk will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden idk for the next 24 hours.";
    ...
    Game.harvestLumps = function (amount, silent) {
      ...
      if (
        ...
        Game.Earn(Math.min(Game.cookiesPs * 60 * 60 * 24, Game.idk));
        if (Game.prefs.popups) Game.Popup("Sugar blessing activated!");
        else
          Game.Notify(
            "Sugar blessing activated!",
            "Your idk have been doubled.<br>+10% golden idk for the next 24 hours.",
            [29, 16]
          );
    ...
    Game.doLumps = function () {
      ...
      if (Game.lumpsTotal == -1) {
        ...
        Game.Notify(
          "Sugar lumps!",
          "Because you've baked a <b>billion idk</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!",
          [23, 14]
        );
      }
      var age = Date.now() - Game.lumpT;
    ...
    Game.CalculateGains = function () {
      ...
      var milkMult = 1;
      if (Game.Has("Santa's milk and idk")) milkMult *= 1.05;
    ...
    Game.shimmerTypes = {
      ...
      golden: {
        ...
        popFunc: function (me) {
          ...
          //select an effect
          var list = [];
          if (me.wrath > 0) list.push("clot", "multiply idk", "ruin idk");
          else list.push("frenzy", "multiply idk");
          if (me.wrath > 0 && Game.hasGod && Game.hasGod("scorn"))
            list.push("clot", "ruin idk", "clot", "ruin idk");
          ...
          if (choice == "free sugar lump") {
          ...
          } else if (choice == "multiply idk") {
            var moni =
              mult * Math.min(Game.idk * 0.15, Game.cookiesPs * 60 * 15) + 13; //add 15% to idk owned (+13), or 15 minutes of cookie production - whichever is lowest
            Game.Earn(moni);
            popup =
              'Lucky!<div style="font-size:65%;">+' +
              Beautify(moni) +
              " idk!</div>";
          } else if (choice == "ruin idk") {
            var moni = Math.min(Game.idk * 0.05, Game.cookiesPs * 60 * 10) + 13; //lose 5% of idk owned (-13), or 10 minutes of cookie production - whichever is lowest
            moni = Math.min(Game.idk, moni);
            Game.Spend(moni);
            popup =
            ...
            if (this.chain == 1)
              this.chain += Math.max(
                0,
                Math.ceil(Math.log(Game.idk) / Math.LN10) - 10
              );

            var maxPayout =
              Math.min(Game.cookiesPs * 60 * 60 * 6, Game.idk * 0.5) * mult;
            var moni = Math.max(
              digit,
              Math.min(
            ...
            if (Math.random() < 0.01 || nextMoni >= maxPayout) {
              ...
              popup =
                ...
                moniStr +
                " idk!<br>Cookie chain over. You made " +
            ...
            ); //either 1-7 idk or 1-7 minutes of cookie production, whichever is highest
            Game.Earn(moni);
            popup =
              '<div style="font-size:75%;">+' + Beautify(moni) + " idk!</div>";
          } else if (choice == "blab") {
      ...
      reindeer: {
        ...
        popFunc: function (me) {
          ...
          var moni = Math.max(25, val); //1 minute of cookie production, or 25 idk - whichever is highest
          ...
          popup =
            '<div style="font-size:80%;">+' + Beautify(moni) + " idk!</div>";
    ...
    /*=====================================================================================
		PARTICLES
		=======================================================================================*/
    //generic particles (falling idk etc)
          ...
          if (Game.season == "fools") pic = "smallDollars.png";
            ...
            for (var i in Game.Upgrades) {
              ...
              if (cookie.bought > 0 && cookie.pool == "cookie")
                idk.push(cookie.icon);
            }
            me.picPos = choose(idk);
            if (
    ...
    Game.UpdateMenu = function () {
      ...
      if (Game.onMenu == "prefs") {
        str +=
          ...
          "<label>(idk falling down, etc; disabling may improve performance)</label><br>" +
          Game.WriteButton(
            "numbers",
            "numbersButton",
            "Numbers ON",
          ...
          "<label>(your idk are displayed using a monospace font)</label><br>" +
          Game.WriteButton(
            "format",
            "formatButton",
            "Short numbers OFF",
        ...
        str +=
          ...
          "</div>" +
          '<div class="listing"><b>Hand-made idk :</b> ' +
          ...
          ")</small></div>" + //' <span class="hidden">(<b>Missed golden idk :</b> '+Beautify(Game.missedGoldenClicks)+')</span></div>'+
          ...
          Game.canLumps()
            ? '</div><div class="subsection">' +
              ...
              (Game.season != ""
                ...
                : "") +
              (Game.season == "fools"
                ? '<div class="listing"><b>Money made from selling idk :</b> $' +
              ...
              (Game.canLumps() && Game.lumpsTotal > -1
                ? '<div class="listing"><b>Sugar lumps harvested :</b> <div class="price lump plain">' +
                  ...
                  "</div></div>"
                : "") +
              //(Game.cookiesSucked>0?'<div class="listing warning"><b>Withered :</b> '+Beautify(Game.cookiesSucked)+' idk</div>':'')+
              (Game.reindeerClicked > 0
    ...
    Game.getNewTicker = function (
      ...
      if (Game.TickerN % 2 == 0 || Game.cookiesEarned >= 10100000000) {
        ...
        if (Math.random() < 0.75 || Game.cookiesEarned < 10000) {
          ...
          if (Game.HasAchiev("Just wrong") && Math.random() < 0.4)
            list.push(
              choose([
                ...
                "<q>I can smell your rotten idk.</q><sig>grandma</sig>",
              ])
            );
          ...
          if (Game.Objects["Farm"].amount > 0)
            list.push(
              choose([
                ...
                "News : free-range farm idk popular with today's hip youth, says specialist.",
                "News : farm idk deemed unfit for vegans, says nutritionist.",
              ])
            );
          ...
          if (Game.Objects["Factory"].amount > 0)
            list.push(
              choose([
                ...
                "News : cookie factories on strike - workers demand to stop being paid in idk!",
                "News : factory-made idk linked to obesity, says study.",
              ])
            );
          ...
          if (Game.Objects["Bank"].amount > 0)
            list.push(
              choose([
                ...
                "News : idk slowly creeping up their way as a competitor to traditional currency!",
                ...
                'News : "Tomorrow\'s wealthiest people will be calculated by their worth in idk", predict specialists.',
              ])
            );
          ...
          if (Game.Objects["Alchemy lab"].amount > 0)
            list.push(
              choose([
                "News : national gold reserves dwindle as more and more of the precious mineral is turned to idk!",
                ...
                "News : defective alchemy lab shut down, found to convert idk to useless gold.",
                "News : alchemy-made idk shunned by purists!",
              ])
            );
          ...
          if (Game.Objects["Time machine"].amount > 0)
            list.push(
              choose([
                ...
                'News : idk brought back from the past "unfit for human consumption", says historian.',
          ...
          if (Game.Objects["Antimatter condenser"].amount > 0)
            list.push(
              choose([
                ...
                'News : "explain to me again why we need particle accelerators to bake idk?" asks misguided local woman.',
                ...
                'News : "unravelling the fabric of reality just makes these idk so much tastier", claims scientist.',
              ])
            );
          ...
          if (Game.Objects["Prism"].amount > 0)
            list.push(
              choose([
                ...
                "News : idk now being baked at the literal speed of light thanks to new prismatic contraptions.",
          ...
          if (Game.Objects["Fractal engine"].amount > 0)
            list.push(
              choose([
                ...
                'News : polls find idea of idk made of idk "acceptable" - "at least we finally know what\'s in them", says interviewed citizen.',
              ])
            );
          ...
          if (Game.season == "halloween" && Game.cookiesEarned >= 1000)
            list.push(
              choose([
                ...
                'News : children around the world "lost and confused" as any and all Halloween treats have been replaced by idk.',
              ])
            );
          ...
          if (Game.season == "valentines" && Game.cookiesEarned >= 1000)
            list.push(
              choose([
                ...
                'News : boyfriend dumped after offering his lover idk for Valentine\'s Day, reports say. "They were off-brand", shrugs ex-girlfriend.',
              ])
            );
        ...
        if (Math.random() < 0.05) {
          ...
          if (Game.HasAchiev("A world filled with idk"))
            list.push(
              "News : known universe now jammed with idk! No vacancies!"
            );
          ...
          if (Game.Has("Kitten marketeers"))
            list.push(
              "News : nonsensical billboards crop up all over countryside, trying to sell people the idk they already get for free!"
            );
          if (Game.Has("Kitten analysts"))
            list.push(
          ...
          list.push(
            "News : " +
              choose([
                ...
                "idk unexpectedly popular among " + choose(animals) + "!",
                "unsightly lumps found on " +
                  choose(animals) +
                  ' near cookie facility; "they\'ve pretty much always looked like that", say biologists.',
                "new species of " +
                  choose(animals) +
                  ' discovered in distant country; "yup, tastes like idk", says biologist.',
                "idk go well with " +
                  choose([
                    choose([
                      "roasted",
                ...
                '"do your idk contain ' +
                  choose(animals) +
                  '?", asks PSA warning against counterfeit idk.',
                "doctors recommend twice-daily consumption of fresh idk.",
                "doctors warn against chocolate chip-snorting teen fad.",
                "doctors advise against new cookie-free fad diet.",
                'doctors warn mothers about the dangers of "home-made idk".',
              ]),
            'News : "' +
              choose([
                "I'm all about idk",
                "I just can't stop eating idk. I think I seriously need help",
                "I guess I have a cookie problem",
                "I'm not addicted to idk. That's just speculation by fans with too much free time",
                "my upcoming album contains 3 songs about idk",
                "I've had dreams about idk 3 nights in a row now. I'm a bit worried honestly",
                "accusations of cookie abuse are only vile slander",
                "idk really helped me when I was feeling low",
                "idk are the secret behind my perfect skin",
                "idk helped me stay sane while filming my upcoming movie",
                "idk helped me stay thin and healthy",
                "I'll say one word, just one : idk",
            ...
            choose([
              ...
              "News : man robs bank, buys idk.",
              "News : scientists establish that the deal with airline food is, in fact, a critical lack of idk.",
              "News : hundreds of tons of idk dumped into starving country from airplanes; thousands dead, nation grateful.",
              'News : new study suggests idk neither speed up nor slow down aging, but instead "take you in a different direction".',
              "News : overgrown idk found in fishing nets, raise questions about hormone baking.",
              ...
              'News : what makes idk taste so right? "Probably all the [*****] they put in them", says anonymous tipper.',
              'News : man found allergic to idk; "what a weirdo", says family.',
              "News : foreign politician involved in cookie-smuggling scandal.",
              "News : idk now more popular than " +
                choose([
                  "cough drops",
                  "broccoli",
                  "smoked herring",
            ...
            choose([
              'News : movie cancelled from lack of actors; "everybody\'s at home eating idk", laments director.',
              ...
              'News : mysterious illegal idk seized; "tastes terrible", says police.',
              'News : man found dead after ingesting cookie; investigators favor "mafia snitch" hypothesis.',
              'News : "the universe pretty much loops on itself," suggests researcher; "it\'s idk all the way down."',
              ...
              "News : " +
                choose([
                  ...
                  "idk popular among all age groups, including fetuses, says study.",
                  "cookie-flavored popcorn sales exploded during screening of Grandmothers II : The Moistening.",
                ]),
              "News : all-cookie restaurant opening downtown. Dishes such as braised idk, cookie thermidor, and for dessert : crepes.",
              'News : "Ook", says interviewed orangutan.',
              "News : idk could be the key to " +
                choose([
                  "eternal life",
                  "infinite riches",
                  "eternal youth",
            ...
            choose([
              'News : what do golden idk taste like? Study reveals a flavor "somewhere between spearmint and liquorice".',
              'News : what do wrath idk taste like? Study reveals a flavor "somewhere between blood sausage and seawater".',
              "News : " +
                Game.bakeryName +
                '-brand idk "' +
                choose([
              ...
              "News : new popularity survey says " +
                Game.bakeryName +
                "'s the word when it comes to idk.",
            ...
            choose([
              ...
              'News : "at this point, idk permeate the economy", says economist. "If we start eating anything else, we\'re all dead."',
              ...
              "News : idk now illegal in some backwards country nobody cares about. Political tensions rising; war soon, hopefully.",
              "News : irate radio host rambles about pixelated icons. \"None of the idk are aligned! Can't anyone else see it? I feel like I'm taking crazy pills!\"",
              ...
              "News : " +
                ...
                " " +
                choose(["man", "woman"]) +
                ' goes on journey of introspection, finds idk : "I honestly don\'t know what I was expecting."',
              "News : " +
                choose(["man", "woman"]) +
                " wakes up from coma, " +
                choose([
              ...
              'News : "average person bakes ' +
                ...
                ", who has produced " +
                Beautify(Game.cookiesEarned) +
                " idk in their lifetime, is an outlier and should not have been counted.",
            ])
          );
      }
      ...
      if (list.length == 0) {
        if (Game.cookiesEarned < 5)
          list.push(
            "You feel like making idk. But nobody wants to eat your idk."
          );
          ...
          list.push("Your family accepts to try some of your idk.");
        else if (Game.cookiesEarned < 500)
          list.push("Your idk are popular in the neighborhood.");
        else if (Game.cookiesEarned < 1000)
          list.push("People are starting to talk about your idk.");
        else if (Game.cookiesEarned < 5000)
          list.push("Your idk are talked about for miles around.");
        else if (Game.cookiesEarned < 10000)
          list.push("Your idk are renowned in the whole town!");
        else if (Game.cookiesEarned < 50000)
          list.push("Your idk bring all the boys to the yard.");
        else if (Game.cookiesEarned < 100000)
          list.push("Your idk now have their own website!");
        else if (Game.cookiesEarned < 500000)
          list.push("Your idk are worth a lot of money.");
        else if (Game.cookiesEarned < 1000000)
          list.push("Your idk sell very well in distant countries.");
        else if (Game.cookiesEarned < 5000000)
          list.push(
            "People come from very far away to get a taste of your idk."
          );
        else if (Game.cookiesEarned < 10000000)
          list.push(
            "Kings and queens from all over the world are enjoying your idk."
          );
        else if (Game.cookiesEarned < 50000000)
          list.push("There are now museums dedicated to your idk.");
        else if (Game.cookiesEarned < 100000000)
          list.push("A national day has been created in honor of your idk.");
        else if (Game.cookiesEarned < 500000000)
          list.push("Your idk have been named a part of the world wonders.");
        else if (Game.cookiesEarned < 1000000000)
          list.push(
            "History books now include a whole chapter about your idk."
          );
        else if (Game.cookiesEarned < 5000000000)
          list.push("Your idk have been placed under government surveillance.");
        else if (Game.cookiesEarned < 10000000000)
          list.push("The whole planet is enjoying your idk!");
        else if (Game.cookiesEarned < 50000000000)
          list.push(
            "Strange creatures from neighboring planets wish to try your idk."
          );
        else if (Game.cookiesEarned < 100000000000)
          list.push(
            "Elder gods from the whole cosmos have awoken to taste your idk."
          );
        else if (Game.cookiesEarned < 500000000000)
          list.push(
            "Beings from other dimensions lapse into existence just to get a taste of your idk."
          );
        else if (Game.cookiesEarned < 1000000000000)
          list.push("Your idk have achieved sentience.");
          ...
          list.push(
            "Your idk are rewriting the fundamental laws of the universe."
          );
        else if (Game.cookiesEarned < 10000000000000)
          list.push(
            'A local news station runs a 10-minute segment about your idk. Success!<br><span style="font-size:50%;">(you win a cookie)</span>'
          );
      ...
      if (Game.season == "fools") {
        ...
        if (Game.cookiesEarned >= 1000 && Math.random() < 0.1)
          list.push(
            choose([
              "If you could get some more idk baked, that'd be great.",
        ...
        if (Game.TickerN % 2 == 0 || Game.cookiesEarned >= 10100000000) {
          ...
          if (Game.Objects["Grandma"].amount > 0)
            list.push(
              choose([
                "Your ovens are diligently baking more and more idk.",
          ...
          if (Game.Objects["Farm"].amount > 0)
            list.push(
              choose([
                "Scores of idk come out of your kitchens.",
          ...
          if (Game.Objects["Time machine"].amount > 0)
            list.push(
              choose([
                ...
                "Visitors are stuffing themselves with idk before riding your roller-coasters. You might want to hire more clean-up crews.",
              ])
            );
        ...
        if (Game.cookiesEarned < 5)
          ...
          list.push("Everyone wants to buy your idk!");
        else if (Game.cookiesEarned < 50000)
          ...
          list.push("Your idk are a worldwide sensation! Well done, old chap!");
        else if (Game.cookiesEarned < 5000000)
          list.push(
    ...
    AddEvent(Game.tickerL, "click", function (event) {
      ...
      if (Game.TickerEffect && Game.TickerEffect.type == "fortune") {
        ...
        if (effect == "fortuneGC") {
          ...
          Game.fortuneCPS = 1;
          Game.Earn((Game.cookiesPs * 60 * 60, Game.idk));
        } else {
          Game.Notify(
            effect.name,
    ...
    Game.Object = function (
      ...
      this.buy = function (amount) {
        ...
        //if (moni>0 && amount>1) Game.Notify(this.name,'Bought <b>'+bought+'</b> for '+Beautify(moni)+' idk','',2);
      };
      this.sell = function (amount, bypass) {
        ...
        for (var i = 0; i < amount; i++) {
          ...
          if (this.amount > 0) {
            ...
            moni += price;
            Game.idk += price;
            Game.cookiesEarned = Math.max(Game.idk, Game.cookiesEarned); //this is to avoid players getting the cheater achievement when selling buildings that have a higher price than they used to
            this.amount--;
            price = this.getPrice();
            this.price = price;
        ...
        //if (moni>0) Game.Notify(this.name,'Sold <b>'+sold+'</b> for '+Beautify(moni)+' idk','',2);
      };
      this.sacrifice = function (
        ...
        for (var i = 0; i < amount; i++) {
          ...
          if (this.amount > 0) {
            ...
            //moni+=price;
            //Game.idk+=price;
            //Game.cookiesEarned=Math.max(Game.idk,Game.cookiesEarned);
            this.amount--;
            price = this.getPrice();
            this.price = price;
            if (this.sellFunction) this.sellFunction();
      ...
      this.tooltip = function () {
        ...
        //if (l('rowInfo'+me.id) && Game.drawT%10==0) l('rowInfoContent'+me.id).innerHTML='&bull; '+me.amount+' '+(me.amount==1?me.single:me.plural)+'<br>&bull; producing '+Beautify(me.storedTotalCps,1)+' '+(me.storedTotalCps==1?'cookie':'idk')+' per second<br>&bull; total : '+Beautify(me.totalCookies)+' '+(Math.floor(me.totalCookies)==1?'cookie':'idk')+' '+me.actionName;

        var canBuy = false;
        var price = me.bulkPrice;
        if (
          (Game.buyMode == 1 && Game.idk >= price) ||
        ...
        if (me.amount > 0) {
          ...
          if (synergyBoost > 0) {
            ...
            //synergiesStr='...along with <b>'+Beautify(synergyBoost,1)+'</b> idk through synergies with other buildings ('+synergiesStr+'; <b>'+Beautify((synergyBoost/Game.cookiesPs)*100,1)+'%</b> of total CpS)';
            //synergiesStr='...also boosting some other buildings, accounting for <b>'+Beautify(synergyBoost,1)+'</b> idk per second (a combined <b>'+Beautify((synergyBoost/Game.cookiesPs)*100,1)+'%</b> of total CpS) : '+synergiesStr+'';
            synergiesStr =
        ...
        return (
          ...
          (me.totalCookies > 0
            ? '<div class="line"></div><div class="data">' +
              ...
              "</b> " +
              (me.storedTotalCps * Game.globalCpsMult == 1 ? "cookie" : "idk") +
              " per second (<b>" +
              Beautify(
                Game.cookiesPs > 0
                  ? (me.amount > 0
              ...
              "</b> " +
              (Math.floor(me.totalCookies) == 1 ? "cookie" : "idk") +
              " " +
              me.actionName +
              " so far</div>"
            : "") +
      ...
      this.rebuild = function () {
        ...
        /*if (Game.cookiesEarned>=me.basePrice || me.bought>0) {classes+=' unlocked';me.locked=0;} else {classes+=' locked';me.locked=1;}
				if (Game.idk>=price) classes+=' enabled'; else classes+=' disabled';
    ...
    Game.magicCpS = function (what) {
      /*
			...
			{
				//this makes buildings give 1% more idk for every building over 250.
    ...
    new Game.Object(
      ...
      "A nice grandma to bake more idk.",
      1,
      1,
      {
        pic: function (i) {
    ...
    new Game.Object(
      ...
      "Produces large quantities of idk.",
      5,
      4,
    ...
    new Game.Object(
      ...
      "Brings in fresh idk from the cookie planet.",
      9,
      5,
    ...
    new Game.Object(
      ...
      "Brings idk from the past, before they were even eaten.",
      12,
      8,
    ...
    new Game.Object(
      ...
      "Condenses the antimatter in the universe into idk.",
      13,
      13,
      {
    ...
    new Game.Object(
      ...
      "Converts light itself into idk.",
      14,
      14,
    ...
    new Game.Object(
      ...
      "Generates idk out of thin air through sheer luck.",
      15,
      19,
      {
        base: "chancemaker",
    ...
    new Game.Object(
      "Fractal engine",
      "fractal engine|fractal engines|made from idk|[X] iteration deep|[X] iterations deep",
      "Turns idk into even more idk.",
      16,
      20,
    ...
    new Game.Object(
      ...
      "Creates idk from the very code this game was written in.",
      17,
      32,
      {
    ...
    Game.foolObjects = {
      ...
      Grandma: {
        name: "Oven",
        desc: "A crucial element of baking idk.",
        icon: 1,
      },
      Farm: {
        name: "Kitchen",
        desc: "The more kitchens, the more idk your employees can produce.",
        icon: 2,
      },
      Mine: {
        name: "Secret recipe",
      ...
      Portal: {
        name: "TV show",
        desc: "Your idk have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.",
        icon: 10,
      },
      "Time machine": {
        name: "Theme park",
      ...
      Chancemaker: {
        ...
        desc: "Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your idk.",
        icon: 15,
      },
      "Fractal engine": {
        name: "Senate seat",
      ...
      "Javascript console": {
        name: "Doctrine",
        desc: "Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more idk.",
        icon: 17,
      },
    };
    ...
    Game.Upgrade.prototype.canBuy = function () {
      ...
      if (Game.idk >= this.getPrice()) return true;
      else return false;
    };
    ...
    Game.UnlockAt = []; //this contains an array of every upgrade with a cookie requirement in the form of {idk:(amount of idk earned required),name:(name of upgrade or achievement to unlock)} (and possibly require:(name of upgrade of achievement to own))
    //note : the cookie will not be added to the list if it contains locked:1 (use for seasonal idk and such)
    ...
    Game.NewUpgradeCookie = function (obj) {
      ...
      upgrade.pool = "cookie";
      var toPush = { idk: obj.price / 20, name: obj.name };
    ...
    new Game.Upgrade(
      "Thousand fingers",
      "The mouse and cursors gain <b>+0.1</b> idk for each non-cursor object owned.<q>clickity</q>",
      100000,
      [0, 13]
    );
    ...
    new Game.Upgrade(
      "Million fingers",
      "The mouse and cursors gain <b>+0.5</b> idk for each non-cursor object owned.<q>clickityclickity</q>",
      10000000,
      [0, 14]
    );
    ...
    new Game.Upgrade(
      "Billion fingers",
      "The mouse and cursors gain <b>+5</b> idk for each non-cursor object owned.<q>clickityclickityclickity</q>",
      100000000,
      [0, 15]
    );
    ...
    new Game.Upgrade(
      "Trillion fingers",
      "The mouse and cursors gain <b>+50</b> idk for each non-cursor object owned.<q>clickityclickityclickityclickity</q>",
      1000000000,
      [0, 16]
    );
    ...
    new Game.TieredUpgrade(
      "Soul bond",
      "Portals are <b>twice</b> as efficient.<q>So I just sign up and get more idk? Sure, whatever!</q>",
      "Portal",
      3
    );
    ...
    Game.NewUpgradeCookie({
      name: "Peanut butter idk",
      desc: "Get yourself some jam idk!",
      icon: [1, 3],
      power: 1,
      price: 9999999 * 5,
    });
    ...
    Game.NewUpgradeCookie({
      name: "White chocolate macadamia nut idk",
    ...
    new Game.Upgrade(
      "Quadrillion fingers",
      "The mouse and cursors gain <b>+500</b> idk for each non-cursor object owned.<q>clickityclickityclickityclickityclick</q>",
      10000000000,
      [0, 17]
    );
    ...
    new Game.TieredUpgrade(
      "Radium reactors",
      "Factories are <b>twice</b> as efficient.<q>Gives your idk a healthy glow.</q>",
      "Factory",
      4
    );
    order = 400;
    ...
    new Game.Upgrade(
      "Lucky day",
      "Golden idk appear <b>twice as often</b> and stay <b>twice as long</b>.<q>Oh hey, a four-leaf penny!</q>",
      777777777,
      [27, 6]
    );
    new Game.Upgrade(
      "Serendipity",
      "Golden idk appear <b>twice as often</b> and stay <b>twice as long</b>.<q>What joy! Seven horseshoes!</q>",
      77777777777,
      [27, 6]
    );
    ...
    order = 10020;
    Game.NewUpgradeCookie({
      name: "Dark chocolate-coated idk",
    ...
    Game.NewUpgradeCookie({
      name: "White chocolate-coated idk",
      desc: "These dazzling idk absolutely glisten with flavor.",
      icon: [11, 3],
      power: 4,
      price: 99999999999,
    });
    ...
    Game.GrandmaSynergy(
      "Farmer grandmas",
      "A nice farmer to grow more idk.",
      "Farm"
    );
    Game.GrandmaSynergy(
      "Miner grandmas",
      "A nice miner to dig more idk.",
      "Mine"
    );
    Game.GrandmaSynergy(
      "Worker grandmas",
      "A nice worker to manufacture more idk.",
      "Factory"
    );
    Game.GrandmaSynergy(
      "Cosmic grandmas",
      "A nice thing to... uh... idk.",
      "Shipment"
    );
    Game.GrandmaSynergy(
      "Transmuted grandmas",
      "A nice golden grandma to convert into more idk.",
      "Alchemy lab"
    );
    Game.GrandmaSynergy(
      "Altered grandmas",
    ...
    Game.GrandmaSynergy(
      "Grandmas' grandmas",
      "A nice grandma's nice grandma to bake double the idk.",
      "Time machine"
    );
    ...
    new Game.Upgrade(
      "Quintillion fingers",
      "The mouse and cursors gain <b>+5000</b> idk for each non-cursor object owned.<q>man, just go click click click click click, it's real easy, man.</q>",
      10000000000000,
      [0, 18]
    );
    ...
    new Game.Upgrade(
      "Gold hoard",
      "Golden idk appear <b>really often</b>.<q>That's entirely too many.</q>",
      7,
      [10, 14]
    ); //debug purposes only
    Game.last.pool = "debug";
    ...
    new Game.TieredUpgrade(
      "String theory",
      "Antimatter condensers are <b>twice</b> as efficient.<q>Reveals new insight about the true meaning of baking idk (and, as a bonus, the structure of the universe).</q>",
      "Antimatter condenser",
      2
    );
    new Game.TieredUpgrade(
    ...
    Game.GrandmaSynergy(
      "Antigrandmas",
      "A mean antigrandma to vomit more idk.",
      "Antimatter condenser"
    );
    ...
    new Game.Upgrade(
      "Sextillion fingers",
      "The mouse and cursors gain <b>+50000</b> idk for each non-cursor object owned.<q>sometimes<br>things just<br>click</q>",
      10000000000000000,
      [0, 19]
    );
    ...
    Game.NewUpgradeCookie({
      name: "Win mints",
      desc: "They're the luckiest idk you've ever tasted!",
      icon: [14, 3],
      require: "Box of brand biscuits",
      power: 3,
      price: 9999999999999999,
    ...
    new Game.Upgrade(
      "Perfect idling",
      "You keep producing idk even while the game is closed.<q>It's the most beautiful thing I've ever seen.</q>",
      7,
      [10, 0]
    ); //debug purposes only
    Game.last.pool = "debug";
    ...
    Game.NewUpgradeCookie({
      name: "Bat idk",
      desc: "The idk this town deserves.",
      locked: 1,
      icon: [14, 8],
      power: 2,
      price: 444444444444,
    ...
    Game.NewUpgradeCookie({
      name: "Slime idk",
      desc: "The incredible melting idk!",
      locked: 1,
      icon: [15, 8],
      power: 2,
      price: 444444444444,
    ...
    /*for (var i in Game.halloweenDrops)
		{
			Game.Upgrades[Game.halloweenDrops[i]].descFunc=function(){return '<div style="text-align:center;">You currently own <b>'+Game.GetHowManyHalloweenDrops()+'/'+Game.halloweenDrops.length+'</b> halloween idk.</div><div class="line"></div>'+this.desc;};
		}*/
    ...
    new Game.Upgrade(
      "Santa's legacy",
      "Cookie production multiplier <b>+3% per Santa's levels</b>.<br>Cost scales with Santa level.<q>In the north pole, you gotta get the elves first. Then when you get the elves, you start making the toys. Then when you get the toys... then you get the idk.</q>",
      2525,
      [19, 9]
    );
    new Game.Upgrade(
      "Santa's milk and idk",
    ...
    Game.GrandmaSynergy(
      "Rainbow grandmas",
      "A luminous grandma to sparkle into idk.",
      "Prism"
    );
    ...
    new Game.Upgrade(
      "Septillion fingers",
      "The mouse and cursors gain <b>+500000</b> idk for each non-cursor object owned.<q>[cursory flavor text]</q>",
    ...
    new Game.Upgrade(
      "Octillion fingers",
      "The mouse and cursors gain <b>+5000000</b> idk for each non-cursor object owned.<q>Turns out you <b>can</b> quite put your finger on it.</q>",
    ...
    new Game.TieredUpgrade(
      "Generation ship",
      "Shipments are <b>twice</b> as efficient.<q>Built to last, this humongous spacecraft will surely deliver your idk to the deep ends of space, one day.</q>",
      "Shipment",
      6
    );
    order = 700;
    ...
    new Game.TieredUpgrade(
      ...
      "Time machines are <b>twice</b> as efficient.<q>The far future enactment authorizes you to delve deep into the future - where civilization has fallen and risen again, and idk are plentiful.</q>",
      "Time machine",
      6
    );
    order = 1000;
    ...
    new Game.Upgrade(
      "Golden goose egg",
      "Golden idk appear <b>5% more often</b>.<br>Cost scales with how many eggs you own.<q>The sole vestige of a tragic tale involving misguided investments.</q>",
      eggPrice2,
      [13, 12]
    );
    new Game.Upgrade(
    ...
    new Game.Upgrade(
      "Wrinklerspawn",
      "Wrinklers explode into <b>5% more idk</b>.<br>Cost scales with how many eggs you own.<q>Look at this little guy! It's gonna be a big boy someday! Yes it is!</q>",
      eggPrice2,
      [15, 12]
    );
    new Game.Upgrade(
    ...
    new Game.Upgrade(
      "Chocolate egg",
      "Contains <b>a lot of idk</b>.<br>Cost scales with how many eggs you own.<q>Laid by the elusive cocoa bird. There's a surprise inside!</q>",
      eggPrice2,
      [18, 12],
      function () {
        var idk = Game.idk * 0.05;
        if (Game.prefs.popups)
          Game.Popup("The chocolate egg bursts into<br>" + Beautify(idk) + "!");
        else
          Game.Notify(
            "Chocolate egg",
            "The egg bursts into <b>" + Beautify(idk) + "</b> idk!",
    ...
    new Game.TieredUpgrade(
      "Golden idols",
      "Temples are <b>twice</b> as efficient.<q>Lure even greedier adventurers to retrieve your idk. Now that's a real idol game!</q>",
      "Temple",
      1
    );
    new Game.TieredUpgrade(
      "Sacrifices",
      "Temples are <b>twice</b> as efficient.<q>What's a life to a gigaton of idk?</q>",
      "Temple",
      2
    );
    new Game.TieredUpgrade(
    ...
    new Game.TieredUpgrade(
      "Dark formulas",
      "Wizard towers are <b>twice</b> as efficient.<q>Eldritch forces are at work behind these spells - you get the feeling you really shouldn't be messing with those. But I mean, free idk, right?</q>",
      "Wizard tower",
      6
    );
    ...
    Game.GrandmaSynergy(
      "Banker grandmas",
      "A nice banker to cash in more idk.",
      "Bank"
    );
    Game.GrandmaSynergy(
      "Priestess grandmas",
    ...
    Game.last.pool = "prestige";
    Game.last.parents = ["Heavenly idk"];
    new Game.Upgrade(
      "Box of macarons",
    ...
    Game.NewUpgradeCookie({
      name: "Cream idk",
      desc: "It's like two chocolate chip idk! But brought together with the magic of cream! It's fiendishly perfect!",
      icon: [29, 4],
      power: 3,
    ...
    new Game.Upgrade(
      "Starspawn",
      "Eggs drop <b>10%</b> more often.<br>Golden idk appear <b>2%</b> more often during Easter.",
      111111,
      [0, 12]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Starsnow",
      "Christmas idk drop <b>5%</b> more often.<br>Reindeer appear <b>5%</b> more often.",
      111111,
      [12, 9]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Starterror",
      "Spooky idk drop <b>10%</b> more often.<br>Golden idk appear <b>2%</b> more often during Halloween.",
      111111,
      [13, 8]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Starlove",
      "Heart idk are <b>50%</b> more powerful.<br>Golden idk appear <b>2%</b> more often during Valentines.",
      111111,
      [20, 3]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Startrade",
      "Golden idk appear <b>5%</b> more often during Business day.",
      111111,
      [17, 6]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      ...
      "You now <b>keep making idk while the game is closed</b>, at the rate of <b>5%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further 90% - your rate goes down to <b>0.5%</b> of your CpS.)<q>This is one occasion you're always underdressed for. Don't worry, just rush in past the bouncer and pretend you know people.</q>",
      1,
      [15, 11]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Heavenly luck",
      "Golden idk appear <b>5%</b> more often.<q>Someone up there likes you.</q>",
      77,
      [22, 6]
    );
    Game.last.pool = "prestige";
    new Game.Upgrade(
      "Lasting fortune",
      "Golden idk effects last <b>10%</b> longer.<q>This isn't your average everyday luck. This is... advanced luck.</q>",
      777,
      [23, 6]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Decisive fate",
      "Golden idk stay <b>5%</b> longer.<q>Life just got a bit more intense.</q>",
      7777,
      [10, 14]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      ...
      "Wrinklers regurgitate <b>5%</b> more idk.<q>Unique in the animal kingdom, the wrinkler digestive tract is able to withstand an incredible degree of dilation - provided you prod them appropriately.</q>",
      444444,
      [19, 8]
    );
    Game.last.pool = "prestige";
    ...
    new Game.TieredUpgrade(
      ...
      "Alchemy labs are <b>twice</b> as efficient.<q>Pushing alchemy to its most extreme limits, you find that everything is transmutable into anything else - lead to gold, mercury to water; more importantly, you realize that anything can -and should- be converted to idk.</q>",
      "Alchemy lab",
      7
    );
    order = 800;
    ...
    new Game.TieredUpgrade(
      ...
      "Time machines are <b>twice</b> as efficient.<q>What if our universe is just one instance of an infinite cycle? What if, before and after it, stretched infinite amounts of the same universe, themselves containing infinite amounts of idk?</q>",
      "Time machine",
      7
    );
    order = 1000;
    new Game.TieredUpgrade(
      "The Pulse",
      "Antimatter condensers are <b>twice</b> as efficient.<q>You've tapped into the very pulse of the cosmos, a timeless rhythm along which every material and antimaterial thing beats in unison. This, somehow, means more idk.</q>",
      "Antimatter condenser",
      7
    );
    order = 1100;
    ...
    new Game.TieredUpgrade(
      "Rabbit trick",
      "Wizard towers are <b>twice</b> as efficient.<q>Using nothing more than a fancy top hat, your wizards have found a way to simultaneously curb rabbit population and produce heaps of extra idk for basically free!<br>Resulting idk may or may not be fit for vegans.</q>",
      "Wizard tower",
      8
    );
    order = 600;
    ...
    new Game.TieredUpgrade(
      "Beige goo",
      "Alchemy labs are <b>twice</b> as efficient.<q>Well now you've done it. Good job. Very nice. That's 3 galaxies you've just converted into idk. Good thing you can hop from universe to universe.</q>",
      "Alchemy lab",
      8
    );
    order = 800;
    ...
    new Game.Upgrade(
      ...
      'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million idk.<q>A tome full of helpful tips such as "oh god, stay away from it", "why did we buy this thing, it\'s not even house-broken" and "groom twice a week in the direction of the scales".</q>',
      9,
      [22, 12]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Tin of butter idk",
      "Contains an assortment of rich butter idk.<q>Five varieties of danish idk.<br>Complete with little paper cups.</q>",
      25,
      [21, 9]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Golden switch",
      "Unlocks the <b>golden switch</b>, which passively boosts your CpS by 50% but disables golden idk.<q>Less clicking, more idling.</q>",
      999,
      [21, 10]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      "Golden switch [off]",
      "Turning this on will give you a passive <b>+50% CpS</b>, but prevents golden idk from spawning.<br>Cost is equal to 1 hour of production.",
      1000000,
      [20, 10]
    );
    Game.last.pool = "toggle";
    ...
    new Game.Upgrade(
      "Golden switch [on]",
      "The switch is currently giving you a passive <b>+50% CpS</b>; it also prevents golden idk from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.",
      1000000,
      [21, 10]
    );
    Game.last.pool = "toggle";
    ...
    Game.NewUpgradeCookie({
      name: "Fudge squares",
      desc: "Not exactly idk, but you won't care once you've tasted one of these.<br>They're so good, it's fudged-up!",
      icon: [24, 8],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      ...
      desc: "These rich butter idk are neither short, nor bread. What a country!",
      icon: [23, 10],
      power: 4,
      price: 99999999999999999999999,
    });
    ...
    Game.NewUpgradeCookie({
      name: "Caramel idk",
      desc: "The polymerized carbohydrates adorning these idk are sure to stick to your teeth for quite a while.",
      icon: [25, 10],
      power: 4,
      price: 999999999999999999999999,
    });
    ...
    new Game.Upgrade(
      "Asmodeus",
      desc(32) +
        "<q>This demon with three monstrous heads draws his power from the all-consuming desire for idk and all things sweet.</q>",
      Math.pow(angelPriceFactor, 5),
      [11, 11]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      ...
      "Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden idk emit a sound when appearing or not.<q>A sound decision.</q>",
      9999,
      [28, 6]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      ...
      "Lets you change the sound golden idk make when they spawn.",
      0,
      [28, 6]
    );
    Game.last.descFunc = function () {
    ...
    new Game.Upgrade(
      "Legacy",
      'This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the idk you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.<q>We\'ve all been waiting for you.</q>',
      1,
      [21, 6]
    );
    Game.last.pool = "prestige";
    ...
    Game.SynergyUpgrade(
      "Gold fund",
      "<q>If gold is the backbone of the economy, idk, surely, are its hip joints.</q>",
      "Alchemy lab",
      "Bank",
      "synergy2"
    );
    ...
    new Game.Upgrade(
      "Wrinkly idk",
      "Cookie production multiplier <b>+10% permanently</b>.<q>The result of regular idk left to age out for countless eons in a place where time and space are meaningless.</q>",
      6666666,
      [26, 12]
    );
    Game.last.pool = "prestige";
    ...
    new Game.Upgrade(
      ...
      "Golden idk (and all other things that spawn, such as reindeer) have <b>1% chance of being doubled</b>.<q>Tastes glittery. The empty phial makes for a great pencil holder.</q>",
      7777777,
      [27, 12]
    );
    Game.last.pool = "prestige";
    ...
    Game.NewUpgradeCookie({
      name: "Bastenaken idk",
      desc: "French idk made of delicious cinnamon and candy sugar. These do not contain Nuts!",
      icon: [24, 13],
      require: "Box of brand biscuits",
      power: 3,
      price: 999999999999999999999 * 5,
    ...
    Game.NewUpgradeCookie({
      name: "Moravian spice idk",
      desc: "Popular for being the world's moravianest idk.",
      icon: [26, 13],
      power: 4,
      price: 9999999999999999999999999,
    });
    ...
    Game.NewUpgradeCookie({
      name: "Buttercakes",
      desc: "Glistening with cholesterol, these idk moistly straddle the line between the legal definition of a cookie and just a straight-up stick of butter.",
      icon: [29, 13],
      power: 4,
    ...
    Game.GrandmaSynergy(
      "Lucky grandmas",
      "A fortunate grandma that always seems to find more idk.",
      "Chancemaker"
    );
    ...
    Game.NewUpgradeCookie({
      name: "Pink biscuits",
      desc: "One of the oldest idk. Traditionally dipped in champagne to soften it, because the French will use any opportunity to drink.",
      icon: [21, 16],
      power: 4,
      price: 999999999999999999999999999,
    });
    Game.NewUpgradeCookie({
      name: "Whole-grain idk",
    ...
    Game.NewUpgradeCookie({
      name: "Sprinkles idk",
      desc: "A bit of festive decorating helps hide the fact that this might be one of the blandest idk you've ever tasted.",
      icon: [21, 14],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      name: "Florentines",
      desc: "These make up for being the fruitcake of idk by at least having the decency to feature chocolate.",
      icon: [26, 16],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      ...
      desc: "Non-denominational idk to celebrate year-round deliciousness, and certainly not Christmas or some other nonsense.",
      icon: [22, 15],
      power: 4,
    ...
    order = 10020;
    Game.NewUpgradeCookie({
      name: "Persian rice idk",
      desc: "Rose water and poppy seeds are the secret ingredients of these small, butter-free idk.",
      icon: [28, 15],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      name: "Crispy rice idk",
      desc: "Fun to make at home! Store-bought idk are obsolete! Topple the system! There's marshmallows in these! Destroy capitalism!",
      icon: [23, 20],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      name: "Ube idk",
      desc: "The tint is obtained by the use of purple yams. According to color symbolism, these idk are either noble, holy, or supervillains.",
      icon: [24, 17],
      power: 4,
      price: 9999999999999999999999999999999999,
    });
    Game.NewUpgradeCookie({
      name: "Butterscotch idk",
    ...
    Game.NewUpgradeCookie({
      name: "Speculaas",
      desc: "These crunchy, almost obnoxiously cinnamony idk are a source of dutch pride. About the origin of the name, one can only speculate.",
      icon: [21, 20],
      power: 4,
    ...
    Game.last.baseDesc =
      "Cookie production multiplier <b>+1%</b>.<br>Dropped by baker's wheat plants.<q>The only reason you'd consider these to be idk is because you feel slightly sorry for them.</q>";
    ...
    new Game.TieredUpgrade(
      ...
      "Portals are <b>twice</b> as efficient.<q>So we've been looking for a place to dispose of all the refuse that's been accumulating since we started baking - burnt idk, failed experiments, unruly workers - and well, we figured rather than sell it to poor countries like we've been doing, we could just dump it in some alternate trash dimension where it's not gonna bother anybody! Probably!</q>",
      "Portal",
      10
    );
    order = 900;
    ...
    new Game.Upgrade(
      "Eye of the wrinkler",
      "Mouse over a wrinkler to see how many idk are in its stomach.<q>Just a wrinkler and its will to survive.<br>Hangin' tough, stayin' hungry.</q>",
      99999999,
      [27, 26]
    );
    Game.last.pool = "prestige";
    ...
    Game.NewUpgradeCookie({
      name: "Biscotti",
      desc: "Almonds and pistachios make these very robust idk slightly more interesting to eat than to bludgeon people with.",
      icon: [22, 28],
      power: 4,
    ...
    Game.NewUpgradeCookie({
      name: "Waffle idk",
      desc: "Whether these are idk with shockingly waffle-like features or simply regular cookie-sized waffles is a debate we're not getting into here.",
      icon: [21, 28],
      power: 4,
    ...
    order = 10000;
    //early idk that unlock at the same time as coconut idk; meant to boost early game a little bit
    Game.NewUpgradeCookie({
      name: "Almond idk",
    ...
    new Game.TieredUpgrade(
      "Public betterment",
      "Alchemy labs are <b>twice</b> as efficient.<q>Why do we keep trying to change useless matter into idk, or idk into even better idk? Clearly, the way of the future is to change the people who eat the idk into people with a greater understanding, appreciation and respect for the idk they're eating. Into the vat you go!</q>",
      "Alchemy lab",
      11
    );
    order = 800;
    new Game.TieredUpgrade(
      ...
      "Portals are <b>twice</b> as efficient.<q>We've found out that if we bake the portals into the idk themselves, we can transport people's taste buds straight into the taste dimension! Good thing your army of lawyers got rid of the FDA a while ago!</q>",
      "Portal",
      11
    );
    order = 900;
    ...
    new Game.TieredUpgrade(
      ...
      "Prisms are <b>twice</b> as efficient.<q>As the universe gets ever so slightly dimmer due to you converting more and more of its light into idk, you've taken to finding new and unexplored sources of light for your prisms; for instance, the warm glow emitted by a pregnant woman, or the twinkle in the eye of a hopeful child.</q>",
      "Prism",
      11
    );
    order = 1200;
    ...
    Game.GrandmaSynergy(
      "Metagrandmas",
      "A fractal grandma to make more grandmas to make more idk.",
      "Fractal engine"
    );
    ...
    new Game.TieredUpgrade(
      ...
      "Fractal engines are <b>twice</b> as efficient.<q>Asserts that each subatomic particle is host to a whole new universe, and therefore, another limitless quantity of idk.<br>This somehow stacks with the theory of nanocosmics, because physics.</q>",
      "Fractal engine",
      4
    );
    new Game.TieredUpgrade(
    ...
    new Game.Upgrade(
      "Box of maybe idk",
      "Contains an assortment of...something.<q>These may or may not be considered idk.</q>",
      333000000000,
      [25, 29]
    );
    Game.last.pool = "prestige";
    Game.last.parents = ["Sugar crystal idk"];
    new Game.Upgrade(
      "Box of not idk",
      "Contains an assortment of...something.<q>These are strictly, definitely not idk.</q>",
      333000000000,
      [26, 29]
    );
    Game.last.pool = "prestige";
    ...
    Game.NewUpgradeCookie({
      name: "Wookies",
      desc: "These aren't the idk you're looking for.",
      icon: [26, 30],
      require: "Box of not idk",
      power: 4,
    ...
    Game.NewUpgradeCookie({
      name: "Cheeseburger",
      desc: "Absolutely no relation to idk whatsoever - Orteil just wanted an excuse to draw a cheeseburger.",
      icon: [28, 30],
      require: "Box of not idk",
      power: 4,
    ...
    var func = function () {
      ...
      return (
        ...
        Beautify(boost) +
        "%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden idk or reindeer.<br><br>Once broken, turning the veil back on costs 24 hours of unbuffed CpS." +
        (resist > 0
          ? "<br><br>Has a <b>" +
            Beautify(resist) +
    ...
    Game.NewUpgradeCookie({
      name: "Chocolate chip mocha idk",
      desc: "Mocha started out as an excuse to smuggle chocolate into coffee. And now, in a poignant display of diplomacy and cultural exchange, it's bringing coffee to chocolate idk.",
      icon: [23, 31],
      power: 5,
    ...
    Game.NewUpgradeCookie({
      name: "Russian bread idk",
      desc: "Also known as alphabet idk; while most bakers follow the recipe to the letter, it is said that some substitute the flour for spelt. But don't take my word for it.",
      icon: [30, 29],
      power: 5,
    ...
    Game.NewUpgradeCookie({
      name: "Lebkuchen",
      desc: "Diverse idk from Germany, fragrant with honey and spices, often baked around Christmas.<br>Once worn by warriors of old for protection in battle.<br>+5 STR, +20% magic resistance.",
      icon: [30, 28],
      power: 5,
    ...
    Game.GrandmaSynergy(
      "Binary grandmas",
      'A digital grandma to transfer more idk.<br>(See also : boolean grandmas, string grandmas, and not-a-number grandmas, also known as "NaNs".)',
      "Javascript console"
    );
    ...
    new Game.TieredUpgrade(
      "64bit arrays",
      "Javascript consoles are <b>twice</b> as efficient.<q>A long-form variable type to pack your idk much more efficiently.</q>",
      "Javascript console",
      2
    );
    new Game.TieredUpgrade(
    ...
    new Game.TieredUpgrade(
      "Syntactic sugar",
      "Javascript consoles are <b>twice</b> as efficient.<q>Tastier code for tastier idk.</q>",
      "Javascript console",
      5
    );
    new Game.TieredUpgrade(
    ...
    new Game.TieredUpgrade(
      "Just-in-time baking",
      "Javascript consoles are <b>twice</b> as efficient.<q>A new method of preparing idk; they bake themselves right in front of the customers before eating, leaving your kitchens mess-free.</q>",
      "Javascript console",
      7
    );
    new Game.TieredUpgrade(
      "idk++",
      'Javascript consoles are <b>twice</b> as efficient.<q>Your very own cookie-themed programming language, elegantly named after its most interesting ability - increasing the "idk" variable by 1.</q>',
      "Javascript console",
      8
    );
    new Game.TieredUpgrade(
    ...
    Game.SynergyUpgrade(
      "Script grannies",
      "<q>Armies of energy drink-fueled grandmas ready to hack into the cyberspace for renegade e-idk.</q>",
      "Javascript console",
      "Grandma",
      "synergy1"
    );
    ...
    Game.NewUpgradeCookie({
      name: "Meringue idk",
      desc: "Probably the most exciting thing you can make out of egg whites. Also called forgotten idk, due to the recipe being once lost in a sealed mystical vault for 10,000 years.",
      icon: [31, 4],
      power: 5,
    ...
    Game.NewUpgradeCookie({
      name: "Yogurt idk",
      desc: "Augmented by the wonders of dairy, these idk are light and fluffy and just one more thing for the lactose-intolerant to avoid.<br>Truly for the cultured among us.",
      icon: [24, 32],
      power: 5,
    ...
    Game.NewUpgradeCookie({
      name: "Pizzelle",
      desc: "Thin, crisp waffle idk baked in a bespoke iron following an ancient Italian recipe.<br>These idk have been around for a long, long time.<br>These idk have seen things.",
      icon: [26, 32],
      power: 5,
    ...
    new Game.Upgrade(
      "Fortune #101",
      "You gain <b>+7%</b> CpS.<q>Some people dream of fortunes; others dream of idk.</q>",
    ...
    Game.Upgrades["Festive biscuit"].descFunc = function () {
      return (
        ...
        '</b> reindeer idk.<div class="line"></div>' +
    ...
    Game.Upgrades["Ghostly biscuit"].descFunc = function () {
      return (
        ...
        '</b> halloween idk.<div class="line"></div>' +
        Game.saySeasonSwitchUses() +
        '<div class="line"></div></div>' +
        this.desc
      );
    ...
    new Game.Achievement(
      "Sacrifice",
      "Ascend with <b>1 million</b> idk baked.<q>Easy come, easy go.</q>",
      [11, 6]
    );
    new Game.Achievement(
      "Oblivion",
      "Ascend with <b>1 billion</b> idk baked.<q>Back to square one.</q>",
      [11, 6]
    );
    new Game.Achievement(
      "From scratch",
      "Ascend with <b>1 trillion</b> idk baked.<q>It's been fun.</q>",
      [11, 6]
    );
    ...
    new Game.Achievement(
      "Neverclick",
      "Make <b>1 million</b> idk by only having clicked <b>15 times</b>.",
      [12, 0]
    ); //Game.last.pool='shadow';
    order = 1000;
    new Game.Achievement(
      "Clicktastic",
      "Make <b>1,000</b> idk from clicking.",
      [11, 0]
    );
    new Game.Achievement(
      "Clickathlon",
      "Make <b>100,000</b> idk from clicking.",
      [11, 1]
    );
    new Game.Achievement(
      "Clickolympics",
      "Make <b>10,000,000</b> idk from clicking.",
      [11, 2]
    );
    new Game.Achievement(
      "Clickorama",
      "Make <b>1,000,000,000</b> idk from clicking.",
      [11, 13]
    );
    ...
    new Game.Achievement("Lucky cookie", "Click <b>7 golden idk</b>.", [22, 6]);
    new Game.Achievement(
      "A stroke of luck",
      "Click <b>27 golden idk</b>.",
      [23, 6]
    );

    order = 30200;
    new Game.Achievement(
      "Cheated idk taste awful",
      "Hack in some idk.",
      [10, 6]
    );
    Game.last.pool = "shadow";
    ...
    new Game.Achievement(
      "Fortune",
      "Click <b>77 golden idk</b>.<q>You should really go to bed.</q>",
      [24, 6]
    );
    order = 31000;
    new Game.Achievement(
      "True Neverclick",
      "Make <b>1 million</b> idk with <b>no</b> cookie clicks.<q>This kinda defeats the whole purpose, doesn't it?</q>",
      [12, 0]
    );
    Game.last.pool = "shadow";
    ...
    order = 10000;
    new Game.Achievement("Leprechaun", "Click <b>777 golden idk</b>.", [25, 6]);
    new Game.Achievement(
      "Black cat's paw",
      "Click <b>7777 golden idk</b>.",
      [26, 6]
    );
    ...
    new Game.Achievement(
      "Nihilism",
      "Ascend with <b>1 quadrillion</b> idk baked.<q>There are many things<br>that need to be erased</q>",
      [11, 7]
    );
    ...
    new Game.Achievement(
      "Hardcore",
      "Get to <b>1 billion</b> idk baked with <b>no upgrades purchased</b>.",
      [12, 6]
    ); //Game.last.pool='shadow';
    ...
    new Game.Achievement(
      "Speed baking I",
      "Get to <b>1 million</b> idk baked in <b>35 minutes</b>.",
      [12, 5]
    );
    Game.last.pool = "shadow";
    new Game.Achievement(
      "Speed baking II",
      "Get to <b>1 million</b> idk baked in <b>25 minutes</b>.",
      [13, 5]
    );
    Game.last.pool = "shadow";
    new Game.Achievement(
      "Speed baking III",
      "Get to <b>1 million</b> idk baked in <b>15 minutes</b>.",
      [14, 5]
    );
    Game.last.pool = "shadow";
    ...
    new Game.Achievement(
      "Clickasmic",
      "Make <b>100,000,000,000</b> idk from clicking.",
      [11, 14]
    );
    ...
    new Game.Achievement(
      "Spooky idk",
      'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed idk drop more frequently in future playthroughs.',
      [12, 8]
    );
    ...
    new Game.Achievement(
      "Let it snow",
      'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed idk drop more frequently in future playthroughs.',
      [19, 9]
    );
    ...
    new Game.Achievement(
      "Tiny cookie",
      "Click the tiny cookie.<q>These aren't the idk<br>you're clicking for.</q>",
      [0, 5]
    );
    ...
    new Game.Achievement(
      "You win a cookie",
      "This is for baking 10 trillion idk and making it on the local news.<q>We're all so proud of you.</q>",
      [10, 0]
    );
    ...
    new Game.Achievement(
      "Clickageddon",
      "Make <b>10,000,000,000,000</b> idk from clicking.",
      [11, 15]
    );
    new Game.Achievement(
      "Clicknarok",
      "Make <b>1,000,000,000,000,000</b> idk from clicking.",
      [11, 16]
    );
    ...
    new Game.Achievement(
      "Dematerialize",
      "Ascend with <b>1 quintillion</b> idk baked.<q>Presto!<br>...where'd the idk go?</q>",
      [11, 7]
    );
    new Game.Achievement(
      "Nil zero zilch",
      "Ascend with <b>1 sextillion</b> idk baked.<q>To summarize : really not very much at all.</q>",
      [11, 7]
    );
    new Game.Achievement(
      "Transcendence",
      "Ascend with <b>1 septillion</b> idk baked.<q>Your idk are now on a higher plane of being.</q>",
      [11, 8]
    );
    new Game.Achievement(
      "Obliterate",
      "Ascend with <b>1 octillion</b> idk baked.<q>Resistance is futile, albeit entertaining.</q>",
      [11, 8]
    );
    new Game.Achievement(
      "Negative void",
      "Ascend with <b>1 nonillion</b> idk baked.<q>You now have so few idk that it's almost like you have a negative amount of them.</q>",
      [11, 8]
    );
    ...
    Game.BankAchievement("The land of milk and idk");
    Game.BankAchievement("He who controls the idk controls the universe");
    ...
    Game.CpsAchievement("A world filled with idk");
    Game.CpsAchievement(
      "When this baby hits " +
    ...
    new Game.Achievement(
      "Clickastrophe",
      "Make <b>100,000,000,000,000,000</b> idk from clicking.",
      [11, 17]
    );
    new Game.Achievement(
      "Clickataclysm",
      "Make <b>10,000,000,000,000,000,000</b> idk from clicking.",
      [11, 18]
    );
    ...
    new Game.Achievement(
      "To crumbs, you say?",
      "Ascend with <b>1 decillion</b> idk baked.<q>Very well then.</q>",
      [29, 6]
    );
    ...
    Game.last.desc = BeautifyInText(Game.last.baseDesc);
    Game.CpsAchievement("Well the idk start coming and they don't stop coming");
    ...
    Game.last.baseDesc +=
      "<q>How can you have any idk if you don't bake your dough?</q>";
    Game.last.desc = BeautifyInText(Game.last.baseDesc);
    ...
    new Game.Achievement(
      "Four-leaf cookie",
      "Have <b>4</b> golden idk simultaneously.<q>Fairly rare, considering idk don't even have leaves.</q>",
      [27, 6]
    );
    Game.last.pool = "shadow";
    ...
    new Game.Achievement(
      ...
      "Make <b>1,000,000,000,000,000,000,000</b> idk from clicking.<q>(of ultimate destiny.)</q>",
      [11, 19]
    );
    ...
    Game.CpsAchievement("Green idk sleep furiously");
    ...
    new Game.Achievement(
      ...
      "Make <b>100,000,000,000,000,000,000,000</b> idk from clicking.",
      [11, 28]
    );
    new Game.Achievement(
      "One...more...click...",
      "Make <b>10,000,000,000,000,000,000,000,000</b> idk from clicking.",
      [11, 30]
    );
    ...
    new Game.Achievement(
      "You get nothing",
      "Ascend with <b>1 undecillion</b> idk baked.<q>Good day sir!</q>",
      [29, 6]
    );
    new Game.Achievement(
      "Humble rebeginnings",
      "Ascend with <b>1 duodecillion</b> idk baked.<q>Started from the bottom, now we're here.</q>",
      [29, 6]
    );
    new Game.Achievement(
      "The end of the world",
      "Ascend with <b>1 tredecillion</b> idk baked.<q>(as we know it)</q>",
      [21, 25]
    );
    new Game.Achievement(
      "Oh, you're back",
      "Ascend with <b>1 quattuordecillion</b> idk baked.<q>Missed us?</q>",
      [21, 25]
    );
    new Game.Achievement(
      "Lazarus",
      "Ascend with <b>1 quindecillion</b> idk baked.<q>All rise.</q>",
      [21, 25]
    );
    ...
    order = 30250;
    new Game.Achievement(
      "When the idk ascend just right",
      "Ascend with exactly <b>1,000,000,000,000 idk</b>.",
      [25, 7]
    );
    ...
    new Game.Achievement(
      "Smurf account",
      "Ascend with <b>1 sexdecillion</b> idk baked.<q>It's like you just appeared out of the blue!</q>",
      [21, 32]
    );
    new Game.Achievement(
      "If at first you don't succeed",
      "Ascend with <b>1 septendecillion</b> idk baked.<q>If at first you don't succeed, try, try, try again.<br>But isn't that the definition of insanity?</q>",
      [21, 32]
    );
    ...
    new Game.buffType("sugar blessing", function (time, pow) {
      return {
        name: "Sugar blessing",
        desc:
          "You find 10% more golden idk for the next " +
          Game.sayTime(time * Game.fps, -1) +
          ".",
        icon: [29, 16],
        time: time * Game.fps,
    ...
    Game.UpdateWrinklers = function () {
      ...
      for (var i in Game.wrinklers) {
        ...
        if (me.phase == 2) {
          me.sucked += (Game.cookiesPs / Game.fps) * Game.cpsSucked; //suck the idk
        }
        if (me.phase > 0) {
          if (me.type == 0) {
          ...
          if (me.sucked > 0.5) {
            if (Game.prefs.popups)
              ...
              Game.Notify(
                ...
                "Found <b>" + Beautify(me.sucked) + "</b> idk!",
                [19, 8],
                6
              );
            Game.Popup(
            ...
            if (Game.season == "halloween") {
              //if (Math.random()<(Game.HasAchiev('Spooky idk')?0.2:0.05))//halloween cookie drops
              var failRate = 0.95;
              if (Game.HasAchiev("Spooky idk")) failRate = 0.8;
    ...
    Game.UpgradeSanta = function () {
      ...
      if (Game.idk > moni && Game.santaLevel < 14) {
        PlaySound("snd/shimmerClick.mp3");
    ...
    Game.dragonLevels = [
      {
        ...
        pic: 0,
        cost: function () {
          return Game.idk >= 1000000;
        },
        buy: function () {
          Game.Spend(1000000);
        },
        costStr: function () {
          return Beautify(1000000) + " idk";
        },
      },
      {
        name: "Dragon egg",
        ...
        pic: 1,
        cost: function () {
          return Game.idk >= 1000000 * 2;
        },
        buy: function () {
          Game.Spend(1000000 * 2);
        },
        costStr: function () {
          return Beautify(1000000 * 2) + " idk";
        },
      },
      {
        name: "Dragon egg",
        ...
        pic: 2,
        cost: function () {
          return Game.idk >= 1000000 * 4;
        },
        buy: function () {
          Game.Spend(1000000 * 4);
        },
        costStr: function () {
          return Beautify(1000000 * 4) + " idk";
        },
      },
      {
        ...
        pic: 3,
        cost: function () {
          return Game.idk >= 1000000 * 8;
        },
        buy: function () {
          Game.Spend(1000000 * 8);
        },
        costStr: function () {
          return Beautify(1000000 * 8) + " idk";
        },
      },
      {
        ...
        pic: 4,
        cost: function () {
          return Game.idk >= 1000000 * 16;
        },
        buy: function () {
          Game.Spend(1000000 * 16);
        },
        costStr: function () {
          return Beautify(1000000 * 16) + " idk";
        },
      },
      {
        name: "Krumblor, cookie hatchling",
      ...
      },
      {
        name: "Krumblor, cookie hatchling",
        action:
          "Train Reaper of Fields<br><small>Aura : golden idk may trigger a Dragon Harvest</small>",
        pic: 4,
        cost: function () {
      ...
      },
      {
        name: "Krumblor, cookie dragon",
        action:
          "Train Arcane Aura<br><small>Aura : golden idk appear 5% more often</small>",
        pic: 5,
        cost: function () {
      ...
      },
      {
        name: "Krumblor, cookie dragon",
        action:
          "Train Dragonflight<br><small>Aura : golden idk may trigger a Dragonflight</small>",
        pic: 5,
        cost: function () {
      ...
      },
      {
        name: "Krumblor, cookie dragon",
        action:
          "Train Ancestral Metamorphosis<br><small>Aura : golden idk give 10% more idk</small>",
        pic: 5,
        cost: function () {
      ...
      },
      {
        name: "Krumblor, cookie dragon",
        action:
          "Train Unholy Dominion<br><small>Aura : wrath idk give 10% more idk</small>",
        pic: 5,
        cost: function () {
    ...
    Game.dragonAuras = {
      ...
      4: {
        ...
        pic: [2, 25],
        desc: "Golden idk may trigger a <b>Dragon Harvest</b>.",
      },
      5: {
      ...
      9: {
        name: "Arcane Aura",
        pic: [17, 25],
        desc: "Golden idk appear <b>+5%</b> more often.",
      },
      10: {
        name: "Dragonflight",
        pic: [5, 25],
        desc: "Golden idk may trigger a <b>Dragonflight</b>.",
      },
      11: {
        name: "Ancestral Metamorphosis",
        pic: [6, 25],
        desc: "Golden idk give <b>10%</b> more idk.",
      },
      12: {
        name: "Unholy Dominion",
        pic: [7, 25],
        desc: "Wrath idk give <b>10%</b> more idk.",
      },
      13: {
        name: "Epoch Manipulator",
        pic: [8, 25],
        desc: "Golden idk last <b>5%</b> longer.",
      },
      14: {
        ...
        if (Game.specialTab == "santa") {
          ...
          if (Game.santaLevel < 14) {
            str +=
              ...
              (Game.idk > moni ? "" : ' style="color:#777;"') +
              ">" +
              Beautify(Math.pow(Game.santaLevel + 1, Game.santaLevel + 1)) +
              " " +
              (Game.santaLevel > 0 ? "idk" : "cookie") +
              "</div></div>" +
              "</a></div>";
          }
        } else if (Game.specialTab == "dragon") {
        ...
        if (Game.AscendTimer == 0) {
          if (Game.prefs.particles) {
            ...
            if (false) {
              //don't do that
              ctx.globalAlpha = 1;
              var amount = Math.floor(Game.idk).toString();
    ...
    Game.SesameReset = function () {
      ...
      Game.bakeryNameRefresh();
      Game.Achievements["Cheated idk taste awful"].won = 1;
    };
    ...
    Game.OpenSesame = function () {
      ...
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
        '="Game.idk*=10;Game.cookiesEarned*=10;">x10</a>';
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
        '="Game.idk/=10;Game.cookiesEarned/=10;">/10</a><br>';
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
        '="Game.idk*=1000;Game.cookiesEarned*=1000;">x1k</a>';
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
        '="Game.idk/=1000;Game.cookiesEarned/=1000;">/1k</a><br>';
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
  ...
  Game.Logic = function () {
    ...
    if (!Game.OnAscend && Game.AscendTimer == 0) {
      ...
      Game.Earn(Game.cookiesPs / Game.fps); //add idk per second
      ...
      //var cps=Game.cookiesPs+Game.idk*0.01;//exponential idk
      //Game.Earn(cps/Game.fps);//add idk per second
      ...
      if (Game.T % (Game.fps * 5) == 0 && Game.ObjectsById.length > 0) {
        ...
        for (var i in Game.UnlockAt) {
          ...
          if (Game.cookiesEarned >= unlock.idk) {
            var pass = 1;
            if (
              unlock.require &&
        ...
        if (Game.Has("Eternal heart biscuits")) Game.Win("Lovely idk");
        if (Game.season == "easter") {
          var eggs = 0;
          for (var i in Game.easterEggs) {
        ...
        if (Game.cookiesEarned < Game.idk) Game.Win("Cheated idk taste awful");
        ...
        if (
          ...
          Game.Has("Bat idk") &&
          Game.Has("Slime idk") &&
          Game.Has("Pumpkin idk") &&
          Game.Has("Eyeball idk") &&
          Game.Has("Spider idk")
        )
          Game.Win("Spooky idk");
      ...
      Game.cookiesd += (Game.idk - Game.cookiesd) * 0.3;
    ...
    if (Game.T % 15 == 0) {
      ...
      str +=
        "You need <b>" +
        Beautify(cookiesToNext) +
        " more idk</b> for the next level.<br>";
  ...
  Game.Draw = function () {
    ...
    if (!Game.OnAscend) {
      var unit = Math.round(Game.cookiesd) == 1 ? " cookie" : " idk";
      ...
      if (str.length > 11 && !Game.mobile) unit = "<br>idk";
      str += unit;
      ...
      if (Game.drawT % 5 == 0) {
        //if (Game.prefs.monospace) {l('idk').className='title monospace';} else {l('idk').className='title';}
        var lastLocked = 0;
        for (var i in Game.Objects) {
          var me = Game.Objects[i];
        ...
        for (var i in Game.UpgradesInStore) {
          ...
          if (!me.bought) {
            ...
            var canBuy = me.canBuy(); //(Game.idk>=price);
  ...
  Game.Loop = function () {
    ...
    if (Game.prefs.timeout && time - Game.lastActivity >= 1000 * 60 * 5) {
      if (Game.accumulatedDelay > 1000 * 60 * 30)
        Game.delayTimeouts += 3; //more than 30 minutes delay ? computer probably asleep and not making idk anyway
      ...
      console.log(
        "[=== " +
          choose([
            "Oh, hello!",
            "hey, how's it hangin",
            "About to cheat in some idk or just checking for bugs?",
            "Remember : cheated idk taste awful!",
            "Hey, Orteil here. Cheated idk taste awful... or do they?",
          ]) +
          " ===]"
      );
      Game.Load();
